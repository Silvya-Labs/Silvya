...
# Created by SunWater_, for Silvya.

echo "Silvya, this installer and all source code is created by SunWater_ and is licensed under Gnu General Public License v3.0"
...
echo "Silvya is ready to use. Note that we have not prepared the models or API keys."
